...
*/
	...
	GPIOPinWrite(GPIOA0_BASE, 0x40, 0x00); //DC
	GPIOPinWrite(GPIOA0_BASE, 0x80, 0x00); //OC
	...
	GPIOPinWrite(GPIOA0_BASE, 0x80, 0x80); //disable
}
//*****************************************************************************
...
*/
	...
	GPIOPinWrite(GPIOA0_BASE, 0x40, 0x40); //DC
	GPIOPinWrite(GPIOA0_BASE, 0x80, 0x00); //OC
